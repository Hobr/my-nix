...
nixos-install --option substituters "https://chaotic-nyx.cachix.org/ https://hyprland.cachix.org https://cosmic.cachix.org/ https://mirrors.ustc.edu.cn/nix-channels/store" --option require-sigs false --show-trace --root /mnt --flake .#handsonic/distortion/overdrive
